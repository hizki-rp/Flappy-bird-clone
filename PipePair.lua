...
--local GAP_HEIGHT = 90   :- gap height shouldnt be a constant but a random value

function PipePair:init(y)
    -- in order to make the gap_height get initialized randomly as its called with the pipes
     self.gap_height = math.random(60,150) 
